...
import DevBackEnd.ForLong.features.login.mapper.JoinMapper;
...
import DevBackEnd.ForLong.common.Util.HashUtil;
import DevBackEnd.ForLong.common.Util.PasswordUtil;
...
public class JoinService {
    ...
    public User saveUser(JoinDTO joinDTO){
        ...
        User user = JoinMapper.toEntity(joinDTO);
