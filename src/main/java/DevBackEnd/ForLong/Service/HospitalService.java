...
import DevBackEnd.ForLong.Converter.HospitalConverter;
...
public class HospitalService {
    ...
    public List<HospitalDto> searchHospital(String keyword) {
        ...
        return hospitalList.stream()
                .map(HospitalConverter.INSTANCE::toHospitalDto)
    ...
    public HospitalDto getHospital(Long hospitalId) {
        ...
        return HospitalConverter.INSTANCE.toHospitalDto(hospital);
    }
    ...
    private List<HospitalDto> getHospitalsByHaversine(double lat, double lon) {
        ...
        for (Hospital hospital : allHospitals) {
            ...
            if (hospitalAddress != null && 
                ...
                if (distance <= 5.0) {
                    nearbyHospitals.add(HospitalConverter.INSTANCE.toHospitalDto(hospital));
                }
            }
        }
